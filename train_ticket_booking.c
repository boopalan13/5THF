...
int main(){
    srand(getpid());
    printf("\n\t\t*WELCOME TO BOOBALAN  TT & BOOKING.COM*\n\n");
            ...
            case 1 ... 4:{
                ...
                for(int i=1;i<=nPassangers;i++){
                    ...
                    if((strcmp(source,"chennai")==0 || strcmp(source,"tambaram")==0) && (strcmp(destination,"trichy")==0 || strcmp(destination,"madurai")==0)){
                        ...
                        if(upperBerth==0 ){
                            printf("Upper Berth(s) are already occupied!\n");
                        }
                        if(lowerBerth==0 ){
                            printf("Lower Berth(s) are already occupied!\n");
                        }
                        else{
                                printf("\n\t\tChoose Berths!\n");
                                askBerth:{
                                ...
                                if(choosBerth==1 && (upperBerth>=choosBerth*nPassangers)){
                                    upperBerth-=1*nPassangers;
                                }
                                else if(choosBerth==2 && (lowerBerth>=choosBerth*nPassangers))
                        ...
                        if(amount==berthAmount){
                            ...
                            printf("Please claim your remaining amount Rs.%d\n",abs(berthAmount-amount));
                            printf("You have successfully booked %d ticket(s)\n\n",nPassangers);
                            berthAmount=500*nPassangers;
                        }
                    }
